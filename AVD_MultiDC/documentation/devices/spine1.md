...
| Ethernet7 | P2P_LINK_TO_BORDERLEAF1_Ethernet3 | routed | - | 192.168.103.200/31 | default | 1550 | False | - | - |
...
| 192.168.101.51 | 65190 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
...
| 192.168.103.201 | 65190 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 192.168.101.51 remote-as 65190
   neighbor 192.168.101.51 description borderleaf1
   ...
   neighbor 192.168.103.201 remote-as 65190
   neighbor 192.168.103.201 description borderleaf1_Ethernet3
